...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                ...
                .antMatchers("/pmgr/").permitAll()
                .antMatchers("/pmgr/{id}").permitAll()
                .antMatchers("/pmgrC/{id}").permitAll()
                .antMatchers("/pmgrA/").permitAll()
                .antMatchers("/pmgrA/{id}/{datedebut}/{datefin}").permitAll()
