...
public class GreetingController {
    ...
    @GetMapping("/pmgr/{id}")
    public List<PMGRPRODUCT> test(@PathVariable Long id){ 
    	...
    	try{
			  ...
			  con=Connection.getcon();
		       ...
		       rs = st.executeQuery("select * from PMGR_PRODUCT PROD,PMGR_PACKAGE PACK WHERE PROD.PRODUCT_ID=PACK.PACKAGE_ID AND PROD.PRODUCT_ID='"+id+"'");
